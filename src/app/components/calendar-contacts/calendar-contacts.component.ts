...
@Component({
  selector: 'app-calendar-contacts',
  templateUrl: './calendar-contacts.component.html',
  styleUrls: ['./calendar-contacts.component.scss']
})
export class CalendarContactsComponent implements OnInit {
