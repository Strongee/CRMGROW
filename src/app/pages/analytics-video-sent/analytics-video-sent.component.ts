...
@Component({
  selector: 'app-analytics-video-sent',
  templateUrl: './analytics-video-sent.component.html',
  styleUrls: ['./analytics-video-sent.component.scss']
})
export class AnalyticsVideoSentComponent implements OnInit {
  selectedWeekly = 0;
